                  ...
                  if(!formData.agreement) {
                        ...
                        try {
                              if (!token) {
                                    ...
                                    const response = await axios.post(apiRoutes.sumbitApplication, formData, {headers});
            ...
            <SoftBox mt={5} mb={3} px={3}>      
                  <SoftBox mb={5} p={4} className="shadow-sm rounded-4 bg-white">
                        ...
                        <ul className="text-danger fw-bold">
                              ...
                              <li className="text-xxs fst-italic">You can no longer update your application once submitted</li>
                              <li className="text-xxs fst-italic">Once aproved, you can no longer delete it</li>
                              <li className="text-xxs fst-italic">If your party member has applied already, your application will be automaticall declined</li>
                              ...
                              <li className="text-xxs fst-italic">You can leave Partylist as blank if you don't have any</li>
                        </ul>
                        <SoftBox mt={2}>
