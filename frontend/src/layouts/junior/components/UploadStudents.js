...
function UploadStudents({HandleRendering, ReloadTable }) {
      ...
      const handleFileChange = (e) => {
            ...
            reader.onload = (event) => {
                ...
                setFormData({ ...formData, data: jsonData }); // Set Excel data in formData
            };
                  ...
                  if(!formData.agreement) {
                        ...
                        try {
                              if (!token || access != 999) {
                                    ...
                                    const response = await axios.post(apiRoutes.uploadExcel, formData, {headers});
                              ...
                              <SoftBox component="form" role="form" className="px-md-0 px-2" onSubmit={handleSubmit}>
                                    <Grid container spacing={0} alignItems="center">
                                          <Grid item xs={12} sm={6} md={4} px={1}>
                                                ...
                                                {/* input here for uploaded excel file */}
                                                <input
                                                      type="file"
                                                      name="data"
                                                      accept=".xlsx, .xls"
